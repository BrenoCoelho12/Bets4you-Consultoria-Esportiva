...
create table aposta (
    ...
    descricao_aposta varchar(200),
	confiança double not null,
...
create table jogo (
    ...
    foreign key(mandante_id) references equipe(id),
    foreign key(equipe_id) references equipe(id)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;


INSERT INTO pais (id, nome, nome_pt, sigla, bacen) 
VALUES
