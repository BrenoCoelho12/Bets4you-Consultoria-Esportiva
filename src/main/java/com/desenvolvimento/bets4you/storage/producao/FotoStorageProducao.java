package com.desenvolvimento.bets4you.storage.producao;
...
@Profile("producao")
@Component
public class FotoStorageProducao implements FotoStorage{

    private static final Logger logger = LoggerFactory.getLogger(FotoStorageProducao.class);

    private Path local;

    public FotoStorageProducao() {
        this(getDefault().getPath(System.getenv("HOME"), "img-bets4you"));

    }

    public FotoStorageProducao(Path path) {
        this.local = path;
        criarPastas();
    }
