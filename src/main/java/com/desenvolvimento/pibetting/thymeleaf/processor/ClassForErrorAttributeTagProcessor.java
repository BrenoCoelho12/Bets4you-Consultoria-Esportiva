package com.desenvolvimento.pibetting.thymeleaf.processor;
...
public class ClassForErrorAttributeTagProcessor extends AbstractAttributeTagProcessor {
	...
	private static final String NOME_ATIBUTO = "classforerror";
	private static final int PRECEDENCIA = 1000; 
	
	public ClassForErrorAttributeTagProcessor(String dialectPrefix) {
		super(TemplateMode.HTML, dialectPrefix, null, false, NOME_ATIBUTO, true, PRECEDENCIA, true);
	}
